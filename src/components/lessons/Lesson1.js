    ...
    return (
        <div className='lesson-wrapper'>
           ...
           <h3>When I complete this lesson: </h3>
            ...
            <p>Python is an extremely popular programming language used by many popular websites including Google, YouTube, Netflix, and Instagram.

            If you have created programs and games with blocks using Scratch, Python makes a great first text-based language. The syntax (the rules for how we write programs) and the keywords (the special words Python understands) are great for beginners.</p>
